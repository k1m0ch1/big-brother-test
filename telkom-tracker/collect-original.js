...
(function(global){
  ...
  if (typeof exports != 'undefined') {
    exports._tar_blowfish = crypto.Blowfish;
  } else {
    global._tar_blowfish = crypto.Blowfish;
  }
  
  }(this));
  
  
  _tar.f.utils = function(){};
  
  _tar.f.utils.prototype = {
    constructor: _tar.f.utils,
    ...
    pageBottomInView: function (element) {
      var pageTop = $(window).scrollTop();
      var pageBottom = pageTop + $(window).height();
      var elementTop = $(element).offset().top;
      var elementBottom = elementTop + $(element).height();
